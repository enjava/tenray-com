...
<%@include file="/WEB-INF/jsp/commons/left.jspf" %>
	<script>		
document.getElementById("address1").className="current";	
</script>	
...
(function(){
	...
	margin-bottom: 0;
				...
				line-height: 42px;
					...
					<link href="css/b5fa9a269a226f2739769221e5b1348b.css" rel="stylesheet" />
					<div class="part right-part">
						<h2 class="title-header" style="text-align: left;">
				<span class="title-content color-6">收件地址</span>
			</h2>
						...
						<div class="homeright pageright f_r usdiv_fr" style="width: 100%;">
							<div>
								<div class="blank"></div>
								<div class="full">
									<!--<div class="ui-button theme_bgcolor" rel="green" id="add_consignee" url="/settings-add_consignee.html">
										<div>
											<span style="color: white;">添加配送地址</span>
										</div>
									</div>-->
								<button class=" aaaa ui-button theme_bgcolor" type="button" rel="green">添加配送地址</button>
...
<div class="modal" id="mymodal" style="top:20%">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background: #EDEDED;padding: 5px;">
    			<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				<div class="dialog-title">添加配送地址</div>
			</div>
			<div class="modal-body">
				<div class="dialog-content">
								<form class="ajax_form" action="/settings-save_consignee.html">
									<div class="control-group small-control-group">
										<label class="control-label">收货人姓名:</label>
										<div class="control-text">
											<input type="text" class="small_textbox w100" value="" name="consignee">
										</div>
										<div class="blank0"></div>
									</div>
									<div class="control-group small-control-group">
										<label class="control-label" style="line-height:38px;">地区:</label>
										<div class="control-text">
											<form id="form1">
												<select id="selProvince" onChange="getCity(this.options[this.selectedIndex].value)" style="padding: 4px 5px;font-size: 14px;border: 1px solid #d7d7d7;">
									...
									<div class="control-group small-control-group">
										...
										<textarea name="address" class="textareabox w250 f_l" style="height:60px;"></textarea>
										<div class="blank0"></div>
									</div>
									<div class="control-group small-control-group">
										<label class="control-label">邮编:</label>
										<div class="control-text">
											<input type="text" name="zip" class="small_textbox w100" value="">
										</div>
										<div class="blank0"></div>
									</div>
									<div class="control-group small-control-group">
										...
										<div class="control-text">
											<input type="text" name="mobile" class="small_textbox w250" value="">
										</div>
									</div>
									<div class="blank10"></div>
									<div class="submit_btn_row control-group">
										<label class="control-label"></label>
										<div class="ui-button theme_bgcolor" rel="green">保存</div>
			...
			<div class="modal-footer" style="border: none;">
							<div class="dialog-button tc" style="display: none;"> <span class="ui-center-button theme_bgcolor dialog-ok" rel="green" style="display: none;">确定</span> <span class="ui-center-button bg_red dialog-cancel" rel="green" style="display: none;">取消</span> </div>
