...
<%@include file="/WEB-INF/jsp/commons/left.jspf" %>
	<script>		
document.getElementById("operating_reward").className="current";	
</script>	
				<div class="part right-part" style="border-left: none;">
					<h2 class="title-header" style="text-align: left;">
				<span class="title-content color-6">推荐项目经营奖励日志</span>
			</h2>
						...
						<div class="self-table">
							<table>
								...
								<tbody id="payslip-detail-list">
									<tr>
										<td colspan="9" style="text-align:center;">没有可以显示的数据</td>
									</tr>
								</tbody>
							</table>
						</div>
